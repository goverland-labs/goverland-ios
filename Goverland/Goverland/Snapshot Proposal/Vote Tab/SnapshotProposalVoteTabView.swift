    ...
    var body: some View {
        VStack {
            ...
            case .vote:
                ...
                case .weighted: SnapshotWeightedQuadraticVotingView(proposal: proposal)
                case .quadratic: SnapshotWeightedQuadraticVotingView(proposal: proposal)
            ...
            case .results:
                ...
                case .weighted: SnapshotWeightedQuadraticVotingResultView(proposal: proposal)
                case .quadratic: SnapshotWeightedQuadraticVotingResultView(proposal: proposal)
