            ...
            ScrollViewReader { proxy in
                ScrollView {
                    VStack(spacing: 8) {
                        ...
                        .id(bottomElementId)
                        .padding(.bottom, isTextEditorFocused ? 50 : 16)
                    }
                }
                ...
                .onChange(of: isTextEditorFocused) {
                    if isTextEditorFocused {
                        // Initially system scrolls to the TextEditor, then we scroll
                        // to the bottom Group element (into message or spacer) to make
                        // buttons visible and not layered on top of other elements.
