            ...
            .navigationDestination(for: Path.self) { path in
                ...
                case .newDaos:
                    FollowCategoryDaosListView(category: .new,
                                               ...
                                               onFollowToggleFromList: { didFollow, _ in if didFollow { Tracker.track(.dashNewDaoFollowFromList) } },
                                               onFollowToggleFromSearch: { didFollow, _ in if didFollow { Tracker.track(.dashNewDaoFollowFromSearch) } },
                ...
                case .popularDaos:
                    FollowCategoryDaosListView(category: .popular,
                                               ...
                                               onFollowToggleFromList: { didFollow, _ in if didFollow { Tracker.track(.dashPopularDaoFollowFromList) } },
                                               onFollowToggleFromSearch: { didFollow, _ in if didFollow { Tracker.track(.dashPopularDaoFollowFromSearch) } },
